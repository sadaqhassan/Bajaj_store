                        ...
                        <form>
                            <div className="grid grid-cols-2 gap-4 mb-5">
                                <div>
                                    ...
                                    <select className="px-3 py-3 text-sm outline-none cursor-pointer text-gray-600 bg-white border rounded-xl border-gray-300">
                                        <option>RE</option>
                                ...
                                <div>
                                    ...
                                    <input  type="number" placeholder="3,000" className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 transition-colors" />  
                                </div>
                            </div>

                            <div className="mb-5">
                                <label className="block text-sm text-gray-500 mb-2">Email contect</label>
                                <input defaultValue={currentUser?.email} type="email" placeholder="samo@company.com" className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 transition-colors"/>
                            </div>

                            <div className="mb-5 grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm text-gray-500 mb-2">Type <span className='text-xs text-gray-400'>new/second</span></label>
                                    <select className="px-3 py-3 text-sm outline-none cursor-pointer text-gray-600 bg-white border rounded-xl border-gray-500">
                                        <option>New</option>
                            ...
                            <div>
                                ...
                                <input  type="number" placeholder="200" className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-indigo-500 transition-colors" />  
                            ...
                            <div className="mb-5">
                                ...
                                <textarea rows="4" placeholder='discription about your bajaj......' className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none resize-y focus:border-indigo-500 transition-colors"/>
                            </div>
